...
public final class SessionFactoryBuilder {
	...
	public static SessionFactory build() {
		final ServiceLoader<SessionFactory> serviceLoader = ServiceLoader
				.load(SessionFactory.class);
		for (final SessionFactory instance : serviceLoader) {
			if (instance != null) {
				return instance;
			}
		}

		throw new TypeNotPresentException(SessionFactory.class.getName(), null);
	}
}
